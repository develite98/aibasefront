...
const User_create_form = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${spread(
    ...
    {}
  )}><form><div class="grid gap-2"><div class="grid gap-1 mb-2">${validate_component(Label, "Label").$$render($$result, { for: "email" }, {}, {
    default: () => {
      return `Email`;
    }
    ...
    {},
    {}
  )}</div> <div class="grid gap-1 mb-4">${validate_component(Label, "Label").$$render($$result, { for: "email" }, {}, {
    default: () => {
      return `Password`;
    }
  })} ${validate_component(Input, "Input").$$render(
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="flex items-stretch page overflow-hidden svelte-1xnlaf"><section class="relative hidden left-container h-full grow-0 text-white lg:flex svelte-1xnlaf" data-svelte-h="svelte-16kb1qp"><div class="flex h-full flex-col justify-between"><video playsinline class="h-full w-full object-cover" autoplay loop muted src="sign-up.mp4"></video></div></section> <section class="flex w-full flex-1 flex-col justify-center overflow-auto"><main class="flex h-full w-full grow items-center justify-center xl:justify-start"><div class="xl:ml-28 w-[380px]"><div class="flex flex-col space-y-2 text-center mb-8" data-svelte-h="svelte-1bdoitf"><h1 class="text-2xl font-semibold tracking-tight">Sign-up</h1> <p class="text-muted-foreground text-sm">Enter your email below</p></div> ${validate_component(User_create_form, "UserCreateForm").$$render($$result, {}, {}, {})}</div></main></section> </div>`;
});
export {
  Page as default
};
